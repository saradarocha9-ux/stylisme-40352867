  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-md justify-end px-4 pb-28 pt-4 pointer-events-auto">
        <div
          className="relative flex max-w-[260px] items-center gap-3 overflow-hidden rounded-2xl border border-white/10 px-3 py-2.5 shadow-lift"
        ...
        >
          ...
          <a
            ...
            className="press flex shrink-0 items-center gap-1 rounded-full px-2.5 py-1.5 text-[10px] uppercase tracking-[0.18em]"
